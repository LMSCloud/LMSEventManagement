...
export const searchSyntax = html`<h4>${__("Advanced Search Syntax")}</h4>
    ...
    <p>
        ${__(
            "This allows the use of various matching clauses including "
        )}<code>&#x3E;</code>${__(", ")}<code>&#x3C;</code>${__(
            ", "
        )}<code>&#x3E;=</code>${__(", ")}<code>&#x3C;=</code>${__(
            ", "
    ...
    <p>
        <strong>${__("Example:")}</strong>&nbsp;<code>name:John AND age:25</code
        >${__(
    ...
    <p>
        <strong>${__("Example:")}</strong>&nbsp;<code
            >surname:Acevedo OR Bernardo</code
        >${__(
    ...
    <p>
        <strong>${__("Example:")}</strong>&nbsp;<code
            >extended_attributes.code:internet AND
            extended_attributes.attribute:1</code
