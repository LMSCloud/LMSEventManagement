...
export default class OpacWidgetSettings extends LitElement {
    ...
    @state() private availableEvents: Array<{
        id: number;
        name: string;
        start_time: string;
    }> = [];
    ...
    private cleanupSelectedEvents() {
        ...
        const selectedIds =
            JSON.parse(this.settings.widget_selected_events) || [];
        ...
        const cleanedIds = selectedIds.filter((id: number) =>
    ...
    private async handleSave(e: Event) {
        ...
        try {
            ...
            const updatedSettings: Partial<WidgetSettings> = {
                ...
                widget_display_mode:
                    (formData.get("widget_display_mode") as string) || "count",
                widget_layout:
                    (formData.get("widget_layout") as string) || "vertical",
                widget_event_count:
                    (formData.get("widget_event_count") as string) ||
                    this.settings.widget_event_count,
                widget_time_period:
                    (formData.get("widget_time_period") as string) ||
                    this.settings.widget_time_period,
                widget_selected_events:
                    (formData.get("widget_selected_events") as string) ||
                    this.settings.widget_selected_events,
                widget_all_events_text:
                    (formData.get("widget_all_events_text") as string) || "",
            };
            ...
            this.state = "success";
            this.renderToast(
                html`${__("Settings saved successfully")}`,
                "success",
            );
        } catch (error) {
            this.state = "error";
                            ...
                            <div class="card bg-white shadow-lg">
                                <div class="card-body">
                                    <h2 class="card-title mb-4 text-2xl">
                                        ${__(
                                            "OPAC Events Widget Configuration",
                                        )}
                                    </h2>
                                    <form
                                    ...
                                    >
                                        ...
                                        <div class="form-control">
                                            ...
                                            >
                                                ...
                                                <span class="label-text ml-2"
                                                    >${__(
                                                        "Enable widget on OPAC homepage",
                                                    )}</span
                                                >
                                            </label>
                                        </div>
                                            ...
                                            >
                                                <input
                                                    ...
                                                    @change=${(e: Event) => {
                                                        ...
                                                        this.settings.widget_auto_inject =
                                                            target.checked
                                                                ? 1
                                                                : 0;
                                                    }}
                                                ...
                                                <span class="label-text ml-2"
                                                    >${__(
                                                        "Automatically inject widget on OPAC main page",
                                                    )}</span
                                                >
                                            </label>
                                            <label class="label">
                                                <span class="label-text-alt">
                                                    ${__(
                                                        "If disabled, manual embedding instructions will be shown",
                                                    )}
                                                </span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-control">
                                            ...
                                            <select
                                                ...
                                                @change=${(e: Event) => {
                                                    ...
                                                    this.settings.widget_display_mode =
                                                        target.value;
                                                    this.requestUpdate();
                                                }}
                                            >
                                            ...
                                            ? html`
                                                  <div class="form-control">
                                                      ...
                                                      <label class="label">
                                                          ...
                                                          >
                                                              ${__(
                                                                  "How many upcoming events to display (1-20)",
                                                              )}
                                                          </span>
                                                      </label>
                                                  </div>
                                        ...
                                        "manual"
                                            ? html`
                                                  <div class="form-control">
                                                      ...
                                                      />
                                                      <div
                                                          class="max-h-64 space-y-2 overflow-y-auto rounded-lg border p-4"
                                                      >
                                                      ...
                                                      <label class="label">
                                                          ...
                                                          >
                                                              ${__(
                                                                  "Select which events to display in the widget",
                                                              )}
                                                          </span>
                                                      </label>
                                                  </div>
                                        ...
                                        <div class="form-control">
                                            ...
                                            <label class="label">
                                                <span class="label-text-alt">
                                                    ${__(
                                                        "Text for the button at the bottom of the widget",
                                                    )}
                                                </span>
                                            </label>
                                        </div>
                            ...
                            <div class="card bg-white shadow-lg">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-info mb-4">
                                        <span class="text-sm">
                                            ${__(
                                                "This preview shows how the widget will appear on the OPAC. Use the location filter in the widget to preview different locations.",
                                            )}
                                        </span>
                                    </div>
