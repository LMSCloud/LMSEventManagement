...
The plugin resolves the correct URL automatically and injects it via `window.__LMS_EVENT_MANAGEMENT_PAGE_URL__` so that components like the OPAC events widget link to the right place regardless of Koha version.
