        ...
        {   'plugin_class' => 'Koha::Plugin::Com::LMSCloud::EventManagement',
            'plugin_key'   => {
                -in => [
                    ...
                    'opac_compact_list_enabled', 'opac_image_crop_enabled',                     'widget_enabled',           'widget_auto_inject',
                    'widget_title',              'widget_display_mode',                         'widget_layout',            'widget_event_count',
                    'widget_time_period',        'widget_selected_events',                      'widget_all_events_text',
                ]
            }
        }
    );
