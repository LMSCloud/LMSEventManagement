...
`;
    ...
    */
    ...
    let LMSEventsFilter = class LMSEventsFilter extends LitElement {
        constructor() {
            super(...arguments);
            this.events = [];
            this.facets = {
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            ${this.facets.locations.map((location) => html `
                <div class="form-check">
                  <label
    ...
    `;
        ...
        _getFieldMarkup(field) {
            ...
            <div class="form-group">
              ...
              >
                ${field.entries.map((entry) => y `<option value=${entry.value}>${entry.name}</option>`)}
              </select>
            </div>
          `;
                    },
