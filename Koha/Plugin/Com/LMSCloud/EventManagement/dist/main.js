...
`;
                ...
                <form @submit=${this.create}>
                  <div class="modal-body">
                    <div
                      ...
                      class="alert alert-${this._alertMessage.includes("Sorry!") && "danger"} alert-dismissible fade show"
                    >
                      ${this._alertMessage}
                      <button
    ...
    __decorate([
        e({ type: String, attribute: false })
    ], LMSModal.prototype, "_alertMessage", void 0);
    __decorate([
        e({ type: String, attribute: false })
    ], LMSModal.prototype, "_modalTitle", void 0);
    __decorate([
        e({ type: Object, attribute: false })
    ], LMSModal.prototype, "_i18n", void 0);
    __decorate([
        e({ type: Boolean, attribute: false })
    ], LMSModal.prototype, "hasResolvedEntries", void 0);
    LMSModal = __decorate([
        e$1("lms-modal")
    ], LMSModal);
...
${value}</textarea
    ...
    let LMSMatrix = class LMSMatrix extends s {
      ...
      <table class="table table-bordered" id=${field.name}>
        ...
        <tbody>
          ${(_b = field.entries) === null || _b === void 0 ? void 0 : _b.map((entry) => {
            var _a;
            return y `<tr>
              <td class="align-middle">${entry.name}</td>
              ${(_a = field.headers) === null || _a === void 0 ? void 0 : _a.map((header) => this.getMatrixInputMarkup({ field, entry, header }))}
            </tr>`;
        })}
        </tbody>
      </table>`;
    ...
    __decorate([
        e({ type: Boolean })
    ], LMSMatrix.prototype, "hasResolvedEntries", void 0);
    __decorate([
        e({ type: Array, attribute: false })
    ...
    __decorate([
        e({ type: Object })
    ], LMSSelect.prototype, "outerScope", void 0);
    __decorate([
        e({ type: Boolean })
    ], LMSSelect.prototype, "hasResolvedEntries", void 0);
    ...
    __decorate([
        e({ type: Function, attribute: false })
    ], LMSEventsModal.prototype, "modalFields", void 0);
    ...
    __decorate([
        e({ type: Function, attribute: false })
    ], LMSEventTypesModal.prototype, "modalFields", void 0);
    ...
    __decorate([
        e({ type: Boolean, attribute: false })
    ], LMSTable.prototype, "_isDeletable", void 0);
    __decorate([
        e({ state: true })
    ], LMSTable.prototype, "_toast", void 0);
    __decorate([
        e({ state: true })
    ], LMSTable.prototype, "_i18n", void 0);
    __decorate([
        e({ state: true })
    ], LMSTable.prototype, "_notImplementedInBaseMessage", void 0);
    LMSTable = __decorate([
        e$1("lms-table")
    ], LMSTable);
    ...
    let LMSEventTypesTable = class LMSEventTypesTable extends LMSTable$1 {
        ...
        connectedCallback() {
            ...
            events
                ...
                .then((result) => {
                this.data = result.map((target_group) => Object.fromEntries(Object.entries(target_group).map(([name, value]) => [
                    name,
                    this.getInputFromColumn({ name, value }),
                ])));
            })
